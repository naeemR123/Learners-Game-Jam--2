...
@onready var countdeb_node: GPUParticles2D = $CounterDebrisParticles
...
func _ready() -> void:
	...
	countdeb_node.process_material = countdeb_material
...
func start(dir: Vector2, pos: Vector2) -> void:
	...
	countdeb_material.direction = -vec3_direction
